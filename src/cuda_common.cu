...
*/
__shared__ float disease_prob[4];
//__shared__ int descentgraph_cache_left[MAX_PEDIGREE_MEMBERS][2];
//__shared__ int descentgraph_cache_right[MAX_PEDIGREE_MEMBERS][2];
